...
export const commercePackages = {
  basic: {
    ...
    revisionLimit: 1,
    retentionMonths: 12,
    limits: { images: 15, assets: 20, storageBytes: 104857600, guests: 100 },
    description: 'Mẫu có sẵn, link riêng, tối đa 15 ảnh và một lần chỉnh sửa.',
  },
  premium: {
    code: 'premium',
    name: 'Cao cấp',
    ...
    revisionLimit: 2,
    retentionMonths: 18,
    limits: { images: 30, assets: 40, storageBytes: 262144000, guests: 500 },
    description: 'Thiệp premium, RSVP, lời chúc, tối đa 30 ảnh và link cá nhân hóa.',
  },
  signature: {
    code: 'signature',
    name: 'Signature',
    ...
    revisionLimit: 3,
    retentionMonths: 24,
    limits: { images: 60, assets: 80, storageBytes: 1073741824, guests: 2000 },
    description: 'Hiệu chỉnh bố cục và motion riêng, tên miền tùy chỉnh và ba lần chỉnh sửa.',
  },
  event_bundle: {
    code: 'event_bundle',
    name: 'Combo sự kiện',
    ...
    revisionLimit: 3,
    retentionMonths: 24,
    limits: { images: 80, assets: 120, storageBytes: 2147483648, guests: 3000 },
    description: 'Thiệp online, slideshow ảnh cưới và background TV hoặc màn LED.',
  },
};
